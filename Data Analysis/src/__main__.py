...
def run_for_gdi(output_file):
    ...
    extract.extract_projects(include=(bookkeeping.GDI_2022+bookkeeping.GDI_2021), exclude=[])
    ...
    for project_2022 in bookkeeping.GDI_2022:
        for project_2021 in bookkeeping.GDI_2021:
            if bookkeeping.extract_name_from_project(project_2022) in project_2021:
                ...
                plot.plot_projects_against_each_other(project_2021, project_2022, output_file, ti.Score_Metric.EXAM)
    ...
    plot.plot_module(bookkeeping.GDI_2021_M_1, "GDI_2021_M_1", output_file, ti.Score_Metric.EXAM)
    plot.plot_module(bookkeeping.GDI_2021_M_2, "GDI_2021_M_2", output_file, ti.Score_Metric.EXAM)
    plot.plot_module(bookkeeping.GDI_2021_M_3, "GDI_2021_M_3", output_file, ti.Score_Metric.EXAM)
    plot.plot_module(bookkeeping.GDI_2021_M_4, "GDI_2021_M_4", output_file, ti.Score_Metric.EXAM)
    plot.plot_module(bookkeeping.GDI_2021_M_5, "GDI_2021_M_5", output_file, ti.Score_Metric.EXAM)
    plot.plot_module(bookkeeping.GDI_2021_M_6, "GDI_2021_M_6", output_file, ti.Score_Metric.EXAM)
    ...
    plot.plot_module(bookkeeping.GDI_2021, "GDI_2021", output_file, ti.Score_Metric.EXAM)
    plot.plot_module(bookkeeping.GDI_2021_DO, "GDI_2021_DO", output_file, ti.Score_Metric.PRESENTATION)
    plot.plot_module(bookkeeping.GDI_2021_DO, "GDI_2021_DO", output_file, ti.Score_Metric.EXAM)
