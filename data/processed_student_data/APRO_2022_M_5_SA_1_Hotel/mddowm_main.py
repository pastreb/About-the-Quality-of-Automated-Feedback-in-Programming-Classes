class Hotel:
  ...
  def _init(self, name, sterne, stockwerke, zimmerProStockwerk, belegung): #Das erste Argument self bei der __init_() Methode ist eine Referenz auf das Objekt. Zb. an3
    self.name = name
    self.sterne = sterne
  ...
  def getGebuchteZimmer(self):
    freieZimmer = self.getGebuchteZimmer() - self.belegung
    return freieZimmer
