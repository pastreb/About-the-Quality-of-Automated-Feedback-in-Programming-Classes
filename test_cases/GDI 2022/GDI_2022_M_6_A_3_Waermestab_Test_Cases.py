...
class Tests(unittest.TestCase):
  ...
  def test_b(self, mocked_stdout):
    ...
    Hint: Die Datei muss 'case_study_metallstab.gif' heissen und im Ordner 'cx_out' abgespeichert werden. """
    with unittest.mock.patch('builtins.input', side_effect=[]) as mocked_input:
      ...
      if len(files) > 0:
        ...
        img = ""
      assert img == "case_study_metallstab.gif", "Die gesuchte Animation wurde nicht gefunden. Tatsächlich vorhandene Bilddateien: " + str(files)
